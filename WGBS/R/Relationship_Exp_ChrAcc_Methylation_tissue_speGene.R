...
#relationship between gene expression, chromatin accessibility and methylation level in tissue-specific gene
...
## genome feature beta value z-score normalization
...
## mean methylation level (beta value) calculate after normalization
...
## get the common gene among three type data
...
## filtering data according to common gene list and sort data according to gene ID
...
## add tissue-specific information of each type data
...
##get the final data used for ploting
...
##the number tissue-specific gene of each tissue should match the row number of data frame
annotation_row = data.frame(Type= factor(rep(c("BrSpe","LiSpe","MuSpe", "PlSpe"), c(204, 114, 76, 132))))
